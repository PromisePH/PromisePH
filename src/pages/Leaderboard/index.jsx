...
function Profile() {
    return (
        <>
            <NavBar />
            <main className='px-4 py-20 md:pb-0 flex flex-col items-center'>
                <section className="pt-16">
                    {/* Top 3 Div */}
                    <div className="flex flex-col items-center bg-bunker rounded-45px px-14 md:px-20 py-3 mb-4">
                        <h className="text-5xl font-bold">Leaderboard</h>
                    ...
                    <div className="flex flex-col items-center bg-bunker md:px-4 rounded-tl-45px rounded-tr-45px">
                        {/* Top 4 Div */}
                        <div className="min-w-full flex flex-row border-b-2 px-10 md:pt-3 py-2 md:pb-3 md:mb-3 md:px-6 items-center">
                            ...
                            <p className="text-2xl text-bruschetta-tomato font-extrabold  pl-32">6296</p>
                        </div>
                        {/* Top 5 Div */}
                        <div className="min-w-full flex flex-row border-b-2 px-10 md:pt-3 py-2 md:pb-3 md:mb-3 md:px-6 items-center">
                            ...
                            <p className="text-2xl text-bruschetta-tomato font-extrabold  pl-32">5877</p>
                        </div>
                        {/* Top 6 Div */}
                        <div className="min-w-full flex flex-row border-b-2 px-10 md:pt-3 py-2 md:pb-3 md:mb-3 md:px-6 items-center">
                            ...
                            <p className="text-2xl text-bruschetta-tomato font-extrabold pl-32">4542</p>
                        </div>
                    </div>
                </section>
            </main>
